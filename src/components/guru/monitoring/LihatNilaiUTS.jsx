...
//           id: siswa.id,
//           nama: siswa.nama,
//           nilaiUts: siswa.nilaiUts.map((nilai) => nilai.nilai), // Mengambil array nilai UTS
//         }));
...
//                   {res.nilaiUts.slice(0, 6).map((nilai, i) => (
    ...
    axios
      ...
      .then((res) => {
        const siswaData = res.data.data.kelas.siswa.map((siswa) => ({
          id: siswa.id,
          nama: siswa.nama,
          nilaiUts: siswa.nilaiUts.map((nilai) => ({
            nilai: nilai.nilai,
