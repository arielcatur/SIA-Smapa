...
//       axios
//         .get("http://localhost:3000/api/wali-murid/nilai-uts", config)
//         .then((res) => {
...
export function NilaiUtsWali() {
  ...
  useEffect(() => {
    axios
      .get("http://localhost:3000/api/wali-murid/nilai-uts", config)
      .then((res) => {
        const currentSemester = res.data.data[0].siswa.semester; // Format: "Satu / 1"
